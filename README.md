...
| zone | width | origin |
|---|---|---|
| aisle 1 | 1.350 m | published, `corridor_width_default` |
| aisle 2 | 1.000 m | published, `corridor_width_dynamic` |
| 90 degree corner | 0.950 m | published, `corridor_width_90_turn` |
| doorway | 1.300 m | published, `doorway_width_default` |
| pinch | 1.340 m | measured, AWS median (V-22) |
| open bay | 2.300 m | measured, AWS p75 (V-22) |

One transport cycle traverses the 1.000 m aisle, the 0.950 m corner and the 1.300 m doorway in
series, so the result is *which published corridor figures the vehicle achieves*, rather than a
cycle count nobody can calibrate. Run it with `tools/run_stack.sh --test-track`.
